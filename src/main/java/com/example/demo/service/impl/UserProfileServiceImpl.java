...
// import com.example.demo.exception.BadRequestException;import org.springframework.security.crypto.password.PasswordEncoder;
...
// public UserProfileServiceImpl(UserProfileRepository repo, PasswordEncoder
// encoder) {
// this.repo = repo;
...
// return repo.findByEmail(email).orElseThrow(() -> new
...
// user.setActive(active);return repo.save(user);
// }
// }